    ...
    for subdir in os.listdir(folder_path):
        ...
        if os.path.isdir(subdir_path):
            ...
            if class_total > 0:
                ...
                with open(f"class_accuracies_torch_{attack_type}.txt", "a") as f:
...
train_dir=f"generated_data/{attack_type}/Training"
val_dir=f"generated_data/{attack_type}/Validation"
