...
def improved_targeted_fgsm(tile_path, target_class="Other", decay_factor=0.9):
    """
    ...
    cv2.imwrite(f"improved-targeted-attack81-to-{target_class}-eps{epsilon}-n{num_steps}.png", 
                cv2.cvtColor(perturbed_image_np, cv2.COLOR_RGB2BGR))

# Test the function
improved_targeted_fgsm("data/Training/Traffic Light/Tlight (81).png", target_class="Other")